...
@implementation TATWKWebViewJavascriptBridge {
    __weak WKWebView* _webView;
    __weak id<WKNavigationDelegate> _webViewDelegate;
    long _uniqueId;
    TATWebViewJavascriptBridgeBase *_base;
}

/* API
 *****/

+ (void)enableLogging { [TATWebViewJavascriptBridgeBase enableLogging]; }

+ (instancetype)bridgeForWebView:(WKWebView*)webView {
    TATWKWebViewJavascriptBridge* bridge = [[self alloc] init];
...
- (void) _setupInstance:(WKWebView*)webView {
    ...
    _base = [[TATWebViewJavascriptBridgeBase alloc] init];
    _base.delegate = self;
}
